...
int main(int argc, char** argv)
{
  ...
  while(1) {
    ...
    for(size_t  i=0; i<n_candidates; i++) {
      ...
      float score1 = beerScore(scoreDataIters[translation1.first]->operator[](translation1.second));

      size_t rand2 = rand() % n_translations;
      pair<size_t,size_t> translation2 = hypotheses[rand2];
      float score2 = beerScore(scoreDataIters[translation2.first]->operator[](translation2.second));

...
GetOptions(
  ...
  "optimizer-executable:s" => \$optimizer_executable,
...
my $mert_extract_cmd           = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "extractor"));
my $mert_mert_cmd              = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "mert"));
my $mert_pro_cmd               = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "pro"));
my $mert_pro_beer_cmd          = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "pro_beer"));
my $mert_mira_cmd              = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "kbmira"));
my $mert_mira_smooth_bleu_cmd  = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "kbmira_smooth_bleu"));
my $mert_mira_bg_bleu_cmd      = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "kbmira_bg_bleu"));
my $mert_mira_beer_cmd         = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "kbmira_beer"));
my $mert_eval_cmd              = ($optimizer_executable ? File::Spec->catfile($mertdir, $optimizer_executable) : File::Spec->catfile($mertdir, "evaluator"));
...
die "Not executable: $mert_pro_beer_cmd"          if ! -x $mert_pro_beer_cmd;
die "Not executable: $mert_mira_cmd"              if ! -x $mert_mira_cmd;
die "Not executable: $mert_mira_bg_bleu_cmd"      if ! -x $mert_mira_bg_bleu_cmd;
die "Not executable: $mert_mira_smooth_bleu_cmd"  if ! -x $mert_mira_smooth_bleu_cmd;
die "Not executable: $mert_mira_beer_cmd"         if ! -x $mert_mira_beer_cmd;

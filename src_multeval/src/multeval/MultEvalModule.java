...
public class MultEvalModule implements Module {
	...
	@Option(shortName = "o", longName = "metrics", usage = "Space-delimited list of metrics to use. Any of: bleu, meteor, beer, ter, length", defaultValue = "bleu meteor beer ter length", arrayDelim = " ")
	...
	public Iterable<Class<?>> getDynamicConfigurables() {
		return ImmutableList.<Class<?>> of(BLEU.class, multeval.metrics.METEOR.class, multeval.metrics.BEER.class, TER.class);
	}
